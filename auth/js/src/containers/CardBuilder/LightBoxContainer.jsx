...
var VizCreator = React.createClass({
    ...
    onSaveConnection: function () {
        this.props.dispatch({type: CardBuilderActionTypes.HIDE_VIZ_CREATOR});
        this.props.dispatch({type: CardBuilderActionTypes.SEND_CUSTOM_VIZ, loadPreview: false});
    },

    onChangeStep: function (step) {
        var self = this;
        return function () {
            self.props.dispatch({type: CardBuilderActionTypes.STEP_VIZ_CREATOR, step: step});
        }
    },
    ...
    onUpdateField: function () {
        ...
        return function (fieldName) {
            return function (event) {
                self.props.dispatch({
                    type: CardBuilderActionTypes.UPDATE_FIELD_VIZ,
                    fieldName: fieldName,
    ...
    onUpdateFileOption: function (fileName, property, value) {
        this.props.dispatch({
            type: CardBuilderActionTypes.EDIT_FILE_OPTION,
            fileName: fileName,
            property: property,
            value: value
        });
    ...
    onChangeStepProp: function (stepID) {
        ...
        return function (config) {
            self.props.dispatch({type: CardBuilderActionTypes.MOD_STEP_CONFIG, stepID: stepID, config: config})
        }
    },
    ...
    onSaveCard: function () {
        var self = this;
        this.props.dispatch({type: CardBuilderActionTypes.SEND_CUSTOM_VIZ, loadPreview: true});
        ...
        this.props.dispatch({type: ActionTypes.SET_HOME_SECTION, section: "ProcessingList"})
    },
        ...
        return (
            <div className={"popup-content d-flex flex-column " + fadeClass}
                ...
                <div className="pt-3 pl-3 d-flex align-items-center">
                    ...
                    <h2 className="mb-0">
                        Card creation assistant - Processing card
                    </h2>
                </div>
                <div className="flex-1 d-flex flex-row bg-white m-3 mh-0"
                    ...
                    <div className="container-p h-100">
                        ...
                        <div className="popup-footer">
                            ...
                            {
                                step === stepNum.length ? (<button onClick={this.onSaveCard} className="btn btn-success btn-sm">
...
function mapStateToProps(state) {
    return {
        ...
        cards: state.cards,
        step: state.cardCreatorSchema.step,
        stepState: state.cardCreatorSchema.stepState,
