                                        ...
                                        <td>
                                            <div className="btn-group">
                                                <button type="button"
                                                        ...
                                                        onClick={function (){ return self.modConnection("in", i, 'unique', true)}}
                                                        disabled={connection.disabled}
                                                >1
                                                </button>
                                                <button type="button"
                                                        className={"btn btn-secondary " + uniqueFalseButtonClass}
                                                        onClick={function (){ return self.modConnection("in", i, 'unique', false)}}
                                                        disabled={connection.disabled}
                                                >
                                                    <i className="fa fa-infinity"/></button>
                                            </div>
                                        </td>
                                        <td>
